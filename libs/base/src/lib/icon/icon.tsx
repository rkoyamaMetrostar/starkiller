...
export enum IconType {
  ...
  alarm = 'alarm',
  alternate_email = 'alernate_email',
  ...
  local_laundry_service = 'local_laundry_servie',
  ...
  navigate_far_before = 'navigate_far_before',
  navigate_far_next = 'navigate_far_next',
  near_me = 'near_me',
...
export function Icon({
  ...
  const classes = classNames(
    'usa-icon',
    {
      'usa-icon--size-3': size === IconSize.size3,
      'usa-icon--size-4': size === IconSize.size4,
      'usa-icon--size-5': size === IconSize.size5,
      'usa-icon--size-6': size === IconSize.size6,
      'usa-icon--size-7': size === IconSize.size7,
      'usa-icon--size-8': size === IconSize.size8,
      'usa-icon--size-9': size === IconSize.size9,
    },
    className
  );
